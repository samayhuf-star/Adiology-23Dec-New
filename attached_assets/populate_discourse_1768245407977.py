...
# CONFIGURATION
# ============================================================================
DISCOURSE_API_KEY = "6cc5302765f2b7e91b927672bfe6b62ece69e09f826f3f4c909cc48dedfa7eb4"
DISCOURSE_URL = "https://adiology.discourse.group"
...
*Last updated: {datetime.now().strftime('%Y-%m-%d')}*"""
            ...
            # Create topic with random user
            random_user = random.choice(client.users)
            topic_id = client.create_topic(topic_title, topic_content, category_id, random_user)
            
            if topic_id:
                # Add 2-3 replies
                num_replies = random.randint(2, 3)
                for _ in range(num_replies):
                    reply_user = random.choice(client.users)
                    ...
                    client.create_reply(topic_id, reply_content, reply_user)
                
                topics_count += 1
            
            # Rate limiting every 5 topics
            if idx % 5 == 0:
